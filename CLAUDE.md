...
- **`gai issue 12,34` (several issues)**: one list `_issue_nums` + `_issue_label`, all attached in one write, one Claude session with every thread; same repo only — see `docs/usage.md#working-an-issue`
